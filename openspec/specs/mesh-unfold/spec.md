# mesh-unfold Specification

## Purpose

Convert a triangulated 3D mesh into a flat, non-overlapping 2D net (islands) with cut edges and fold classification, following the greedy priority-based unfold algorithm in DESIGN.md.
