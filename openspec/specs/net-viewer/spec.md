# net-viewer Specification

## Purpose

Render the unfolded net in the Print Preview pane as a derived view of the latest mesh, with a spinner during computation, stale-result protection, and clear failure states.
