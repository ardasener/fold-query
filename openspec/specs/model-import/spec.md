...
Import external 3D models into the tool via a native file picker, routing CAD solids (STEP/BREP/DXF) to code projects and triangle meshes (OBJ/STL/PLY/glTF) to mesh projects.
