# mesh-simplification Specification

## Purpose

Decimate oversized meshes with quadric-error-metric simplification before unfolding, using a configurable maximum face count, reporting simplification stats and falling back gracefully on failure.
